...
# # FIXME Add CLS token to the images
# # TODO Use CLS or average pooling as a config option


# class AttentionBlock(nn.Module):
#     def __init__(self):
#         super().__init__()
#         # TODO Make these dims configurable
#         self.w_k = nn.Linear(in_features=64, out_features=24)
#         self.w_q = nn.Linear(in_features=64, out_features=24)
#         self.w_v = nn.Linear(in_features=64, out_features=32)
...
#         # TODO Apply linear FF
#         # TODO Residual add and norm
#         return h


# class VisionTransformerEncoder:
#     def __init__(self):
#         # TODO Define constants in config
#         self.patch_proj = nn.Linear(in_features=196, out_features=64)
#         # TODO Add sequence of attention blocks

#     def forward(self, x):
#         x = torch.matmul(x, self.patch_proj)
#         # TODO Apply a sequence of attention blocks


# class VisionTransformerClassifier:
#     def __init__(self):
#         self.encoder = VisionTransformerEncoder()
#         self.classification_head = nn.Linear(in_features=64, out_features=10)

#     def forward(self, x):
#         encoding = self.encoder(x)
#         # TODO Extract the first (CLS) token
#         return self.classification_head(cls)
